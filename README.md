...
### Första etappen - tas med till Code Review 15/1
...
För att kicka igång programmet behöver ni i er "script.js" först ta bort testkoden från förra veckan som anroper "checkForGameOver()", och istället anropa funktionen "prepGame()". Jag har uppdeterat startkoden med min version lösning av förra veckans problem, samt tagit bort testanropen till "checkForGameOver()".
